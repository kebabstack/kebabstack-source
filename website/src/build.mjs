...
<section class="section shell faq"><div><p class="eyebrow">FAQ</p><h2>${esc(c.faqTitle)}</h2></div><div class="faq-list">${c.faq.map((f) => `<details><summary>${esc(f[0])}${icon("plus")}</summary><p>${esc(f[1])}</p></details>`).join("")}</div></section>
