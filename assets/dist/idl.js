...
export const idlFactory = ({ IDL }) => {
  const ValuationInput = IDL.Record({ currency: IDL.Text, inServiceOn: IDL.Text, months: IDL.Nat, priceMinor: IDL.Nat, purchasedOn: IDL.Text, reason: IDL.Text, residualMinor: IDL.Nat });
  ...
  const FinanceAsset = IDL.Record({ archived: IDL.Bool, assignee: IDL.Text, bookMinor: IDL.Opt(IDL.Nat), id: IDL.Nat, kind: IDL.Text, name: IDL.Text, purchase: IDL.Opt(Purchase), revision: IDL.Nat, serial: IDL.Text, status: IDL.Text, tag: IDL.Text, valuation: IDL.Opt(Valuation) });
  ...
  return IDL.Service({
    ...
    financeAsset: IDL.Func([IDL.Text, IDL.Nat, IDL.Text], [IDL.Opt(IDL.Record({ asset: FinanceAsset, history: IDL.Vec(Valuation) }))], ["query"]),
    financeInventory: IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Nat], [IDL.Opt(IDL.Record({ defaults: IDL.Vec(IDL.Record({ kind: IDL.Text, months: IDL.Nat })), defaultsRevision: IDL.Nat, matched: IDL.Nat, missing: IDL.Nat, rows: IDL.Vec(FinanceAsset), totals: IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat)) }))], ["query"]),
    financeInventoryCsv: IDL.Func([IDL.Text, IDL.Text], [IDL.Text], ["query"]),
    ...
    paymentsExportCsv: IDL.Func([IDL.Text], [IDL.Text], ["query"]),
    ...
    saleFinanceNotification: IDL.Func([IDL.Text, IDL.Nat], [IDL.Vec(IDL.Record({ complete: IDL.Bool, detail: IDL.Text, kind: IDL.Text }))], ["query"]),
    ...
    salePaymentHistory: IDL.Func([IDL.Text, IDL.Nat], [IDL.Opt(IDL.Record({ canRecord: IDL.Bool, entries: IDL.Vec(PaymentEntry), outstandingMinor: IDL.Nat, paidMinor: IDL.Nat, revision: IDL.Nat }))], ["query"]),
