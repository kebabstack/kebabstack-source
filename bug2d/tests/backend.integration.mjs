...
try{
 ...
 const initialVersion=baseline?'0.1.0':'0.2.0';
 ...
 const score={runId:run.id,meters:500n,coins:[0n,1n,2n],durationMs:10000n,version:initialVersion};
 ...
 assert.equal((await a.actor.info()).version,'0.2.0');
