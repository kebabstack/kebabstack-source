...
node --test test/operations-ui.mjs test/displays-ui.mjs test/updates-ui.mjs test/permissions-ui.mjs test/company-teams.mjs test/handoff.mjs test/data-sharing.mjs test/connect-flow.mjs ../sdk/tools/signin.test.mjs ../sdk/tools/topbar.test.mjs
...
T=$(mktemp -d); cp dist/company-teams.js dist/index.html dist/permissions.js dist/updates.js dist/operations.js dist/displays.js test/smoke.mjs "$T/"; mkdir -p "$T/sdk"; cp dist/sdk/hub-client.js "$T/sdk/"
