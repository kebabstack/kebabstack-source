// postal-mime 2.7.6 (https://github.com/postalsys/postal-mime) — MIT-0 License, Copyright (c) 2021-2025 Andris Reinman.
// Bundled unmodified from the npm package's ESM sources (esbuild --bundle --format=esm --platform=browser) so the .eml upload can parse MIME in the browser.
// Refresh: contracts/tools/bundle-postal-mime.sh
